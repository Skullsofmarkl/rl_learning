"""
Основной скрипт для сравнительного анализа алгоритмов RL.

Запускает обучение и сравнение всех 4 алгоритмов:
- DQN
- PPO  
- SAC
- A2C
...
def run_complete_comparison(episodes=100, max_steps=1000, save_models=True):
    ...
    Args:
        episodes: Количество эпизодов для обучения каждого алгоритма
